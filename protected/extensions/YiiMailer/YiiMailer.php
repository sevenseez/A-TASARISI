...
class YiiMailer extends PHPMailer {
	 ...
	 */
	public function setSmtp($host='localhost',$port=587, $secure='tsl', $auth=true, $username='', $password='')
	{
		$this->isSMTP();
		...
		$this->SMTPAuth = $auth;
		$this->Username = 'kou_bilgi-islem@hotmail.com';
		$this->Password = 'kocaeli41';
	}
}
