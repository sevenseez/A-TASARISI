...
<link rel="stylesheet" href='<?php echo BaseUrl;?>/css/admin/table.css'>
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header"><a class="no-link-features" href="birimler">Birimler</a></h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
        <div class="row">
            <div class="col-lg-12">
                ...
                <?php echo CHtml::ajaxButton('Ekle', Yii::app()->createUrl('tables/insert',array('table'=>'Birimler')), 
                        array(
                            'type'=>'POST',
                            ...
                            <div class="form-group">
                                ...
                                echo CHtml::dropDownList('pageSize', $pageSize, array(10 => 10, 20 => 20, 30 => 30), array(
                                    'class' => 'form-control', 'id' => 'per_page','table'=>'Birimler',
                                        )
                                );
                                ?>
                                    ...
                                    array
                                        ...
                                        'buttons' => array(
                                            'edit' => array
                                                ...
                                                'label' => '',
                                                'imageUrl' => false,
                                                'url' => 'Yii::app()->createUrl("tables/edit",array("id"=>$data->birim_id,"table"=>"Birimler"))',
                                                'options' => array(
                                                    'title' => 'Düzenle',
                                                    'class' => 'fa fa-pencil',
    ...
    <!-- /#page-wrapper -->
   <div id="insertContent" class="birimContent"></div>
   <div id="editContent" class="birimContent" ></div>
...
<?php  Yii::app()->clientScript->registerCoreScript('jquery');     
        ...
        Yii::app()->clientScript->registerCoreScript('jquery.bbq'); 
        Yii::app()->clientScript->registerCoreScript('yii.gridview'); ?> 
